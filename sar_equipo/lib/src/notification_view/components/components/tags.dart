  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        buildTag(context, color: const Color(0xFF23CF91), title: "Atendidos"),
        buildTag(context, color: const Color(0xFF3A6FF7), title: "Eliminados"),
        buildTag(context, color: const Color(0xFFF3CF50), title: "Parecidos"),
        buildTag(context, color: const Color(0xFF8338E1), title: "Todos"),
      ],
    );
  }
